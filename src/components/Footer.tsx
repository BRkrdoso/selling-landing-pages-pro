      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="#hero" className="text-gray-400 hover:text-neon transition-colors">Home</a></li>
              <li><a href="#benefits" className="text-gray-400 hover:text-neon transition-colors">Benefícios</a></li>
              <li><a href="#comparison" className="text-gray-400 hover:text-neon transition-colors">Antes & Depois</a></li>
              <li><a href="#testimonials" className="text-gray-400 hover:text-neon transition-colors">Depoimentos</a></li>
            </ul>
          </div>
          <div>
        ...
        <div className="border-t border-white/5 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6">
            ...
            <a href="#" className="text-gray-500 text-sm hover:text-neon transition-colors">Política de Privacidade</a>
          </div>
        </div>
      </div>
    </footer>
