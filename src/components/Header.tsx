    ...
    <header className="fixed top-0 left-0 right-0 z-50 bg-dark-950/80 backdrop-blur-md border-b border-white/10">
      <div className="container mx-auto flex items-center justify-between py-4">
        ...
        <nav className="hidden md:flex items-center gap-6">
          <a href="#benefits" className="text-sm text-gray-300 hover:text-neon transition-colors">Benefícios</a>
          <a href="#comparison" className="text-sm text-gray-300 hover:text-neon transition-colors">Antes & Depois</a>
          <a href="#testimonials" className="text-sm text-gray-300 hover:text-neon transition-colors">Depoimentos</a>
          <a href="#about" className="text-sm text-gray-300 hover:text-neon transition-colors">Sobre o Criador</a>
        </nav>
